...
export default function AcneDetector() {
  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      // If preview is a blob URL, convert it to a data URL
      if (preview?.startsWith("blob:")) {
        imageDataUrl = await convertBlobToDataUrl(preview);
      }
      ...
      const res = await fetch(`${API}/generate-pdf`, {
        ...
        body: JSON.stringify({
          ...
          yolo_image: result.yolo_image || null,
        }),
      });
      ...
      a.download = "Acne_Detection_Report.pdf";
      a.click();
